...
const ProjectsSection = () => (
  <section className="mb-16">
    <h2 className="text-3xl font-bold text-white/90 mb-8 text-center">Featured Projects</h2>
      ...
      <CardHeader>
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-2">
          <div className="flex items-center gap-3">
            ...
            />
            <CardTitle className="text-xl text-white/90">Takeout Podcast</CardTitle>
          </div>
      ...
      <CardContent>
        ...
        <div className="flex flex-wrap gap-2">
          {["Audio Editing and Sound Design", "Project Management", "Topic Research", "Communication and Public Speaking"].map((skill) => (
            <Badge key={skill} variant="outline" className="border-[#66666e] dark:border-[#9999a1] text-white/90 py-1.5">
              {skill}
            </Badge>
          ))}
        </div>
