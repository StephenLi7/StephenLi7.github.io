...
const EducationSection = () => {
  ...
  return (
    <section className="mb-16">
      <h2 className="text-3xl font-bold text-foreground/90 mb-8 text-center">Education</h2>
      <Card className="hover:shadow-lg transition-shadow duration-300 border-0 bg-[#2d2d2d]/80 backdrop-blur-sm">
        <CardHeader>
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-2">
            <div className="flex items-center gap-3">
              ...
              />
              <div>
                <CardTitle className="text-xl text-foreground/90">University of Pennsylvania</CardTitle>
        ...
        <CardContent>
          <div className="space-y-6">
            {/* Key Courses Section */}
            <div>
              <h4 className="text-lg font-semibold text-foreground/90 mb-3">Key Courses</h4>
              <div className="flex flex-wrap gap-2">
                {keyCourses.map((course, index) => (
                  <Badge key={index} variant="outline" className="border-[#9999a1] text-foreground/90 py-1.5">
                    {course}
                  </Badge>
                ))}
              </div>
            ...
            <div>
              <h4 className="text-lg font-semibold text-foreground/90 mb-3">Organizations</h4>
              <div className="flex flex-wrap gap-2">
